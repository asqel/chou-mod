...
import fr.asqel.chou.client.entityModels.canoe_patch;
...
public class ModEntityModelLayers {
    ...
    public static final ModelLayerLocation CANOE_PATCH = createMain("canoe_patch");
	...
	public static void registerModelLayers() {
		...
		ModelLayerRegistry.registerModelLayer(ModEntityModelLayers.CANOE_PATCH, canoe_patch::createBodyLayer);
	}
