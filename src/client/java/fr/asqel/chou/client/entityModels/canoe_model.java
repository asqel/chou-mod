...
public class canoe_model extends EntityModel<BoatRenderState> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone = partdefinition.addOrReplaceChild("bone", CubeListBuilder.create(), PartPose.offsetAndRotation(0, -20, 0, 0, (float)Math.toRadians(90), 0));
		PartDefinition paddles= partdefinition.addOrReplaceChild("paddles", CubeListBuilder.create(), PartPose.offsetAndRotation(0, -2.25f, 0, 0, (float)Math.toRadians(0), 0));

		PartDefinition front = bone.addOrReplaceChild("front", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 22.0F, -15.0F, 0.0F, -3.1416F, 0.0F));
		...
		PartDefinition left = bone.addOrReplaceChild("left", CubeListBuilder.create().texOffs(0, 19).addBox(-14.0F, -7.0F, -1.0F, 28.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(9.0F, 22.0F, 0.0F, 0.0F, 1.5708F, 0.0F));
		...
		PartDefinition right = bone.addOrReplaceChild("right", CubeListBuilder.create().texOffs(0, 27).addBox(-14.0F, -7.0F, -1.0F, 28.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-9.0F, 22.0F, 0.0F, 0.0F, -1.5708F, 0.0F));
		...
		PartDefinition back = bone.addOrReplaceChild("back", CubeListBuilder.create(), PartPose.offset(4.0F, 22.0F, 15.0F));
		...
		PartDefinition bottom = bone.addOrReplaceChild("bottom", CubeListBuilder.create().texOffs(0, 0).addBox(-18.0F, -9.0F, -3.0F, 36.0F, 16.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 21.0F, 0.0F, 0.0F, 1.5708F, -1.5708F));
...
//		.texOffs(56, 55).addBox(-0.2495F, -3.5F, 0.25F, 1.0F, 6.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-13.7908F, 18.6575F, -5.3273F, 2.1642F, -0.8727F, -2.8798F));
    	...
    	paddles.addOrReplaceChild("paddle_left", CubeListBuilder.create().texOffs(0, 96).addBox(-1.0F, 0.0F, -5.0F, 2.0F, 2.0F, 18.0F).addBox(-1.001F, -3.0F, 8.0F, 1.0F, 6.0F, 7.0F), PartPose.offsetAndRotation(3.0F, -5.0F, 9.0F, 0.0F, 0.0F, 0.19634955F));
    	paddles.addOrReplaceChild("paddle_right", CubeListBuilder.create().texOffs(48, 96).addBox(-1.0F, 0.0F, -5.0F, 2.0F, 2.0F, 18.0F).addBox(0.001F, -3.0F, 8.0F, 1.0F, 6.0F, 7.0F), PartPose.offsetAndRotation(3.0F, -5.0F, -9.0F, 0.0F, (float)Math.PI, 0.19634955F));
	...
	public void setupAnim(BoatRenderState state) {
		animatePaddle(state.rowingTimeLeft, 0, this.paddle_left);
